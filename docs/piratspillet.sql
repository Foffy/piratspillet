...
CREATE TABLE piratspillet.coins (id int NOT NULL AUTO_INCREMENT, gameId int NOT NULL, player varchar(25) NOT NULL, fromPlayer varchar(25), gold int(6) DEFAULT 0, silver int(6) DEFAULT 0, whore int(6) DEFAULT 0, PRIMARY KEY (gameId,player), FOREIGN KEY (gameId) REFERENCES piratspillet.games(id));
