		...
		$(this).each(function () {
			...
			if (this.tweetMachine) {
				...
				settings = $.extend({
					...
					rate:           2000, // Rate in ms to refresh the tweets. Any higher than 5000 for search/tweets will get you rate limited
					...
					tweetFormat: "<table border="1"><tr><li class='tweet'><td><img class='avatar' src=''/></td><td><div class='meta'><a href='' class='username'></a><a href='' class='time'></a></div><p class='content'></p></td></tr></li></table>", // Format for each tweet
