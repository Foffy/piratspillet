		...
		$(this).each(function () {
			...
			if (this.tweetMachine) {
				...
				settings = $.extend({
					...
					tweetFormat: "<li class='tweet'><div class='meta'><a href='' class='username'></a>&nbsp;-&nbsp;<a href='' class='time'><img class='avatar' src=''/>&nbsp;&nbsp;&nbsp;</a></div><p class='content'></p></br></br></li>", // Format for each tweet
