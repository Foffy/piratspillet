$.post("http://beta.piratspillet.dk/index.php/updatedb", {'data':['help','games']});
...
//$.post("http://beta.piratspillet.dk/index.php/updatedb", {'data':['debug','coins','1', 'Foffy', '2','3','1']});
//$.post("http://beta.piratspillet.dk/index.php/updatedb", {'data':['debug','sips','1', 'Emil', '9001', '4']});
